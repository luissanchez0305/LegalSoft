    ...
    <!-- New-Log-Section -->
        <form id="add-new-file-form">
            ...
            <fieldset class="form-group col-md-6">
                ...
                <label>Tipo</label>
                <select class="form-control" id="file-item-type" name="file-item-type" data-parsley-check-file-type>
                    <option></option>
            ...
            <fieldset class="form-group col-md-6">
                ...
                <textarea class="form-control" id="file-item-description" name="file-item-description" rows="3"></textarea>
