                ...
                <tbody>
                  <tr>
                    <td>
                      ...
                      <input type="text" class="form-control ac-control" id="board_director_name" name="board_director_name" value="" ac-method="clients" required title="Inserte el nombre de director">
                      <div class="ac-container"></div>
                    </td>
                    <td>
                      <input type="text" class="form-control ac-control" id="board_director_last_name" name="board_director_last_name" value="" ac-method="clients" ac-master-field="board_directorId" required title="Inserte el nombre">
                      <div class="ac-container"></div>
                    </td>
                    <td>
                      <input type="text" class="form-control ac-ruc" id="board_director_id" name="board_director_id" value="" required title="Inserte el ID del director">
                    </td>
                    <td>Director</td>
                  </tr>
                  <tr>
                    <td>
                      ...
                      <input type="text" class="form-control ac-control" id="board_secretario_name" name="board_secretario_name" value="" ac-method="clients" required title="Inserte el nombre del secretario">
                      <div class="ac-container"></div>
                    </td>
                    <td>
                      <input type="text" class="form-control ac-control" id="board_secretario_last_name" name="board_secretario_last_name" value="" ac-method="clients" ac-master-field="legal_secretarioId" required title="Inserte el nombre del secretario">
                      <div class="ac-container"></div>
                    </td>
                    <td>
                      <input type="text" class="form-control ac-ruc" id="board_secretario_id" name="board_secretario_id" value="" required title="Inserte el RUC del secretario">
                    </td>
                    <td>Secretario</td>
                  </tr>
                  <tr>
                    <td>
                      ...
                      <input type="text" class="form-control ac-control" id="board_tesorero_name" name="board_tesorero_name" value="" ac-method="clients" required title="Inserte el nombre del tesorero">
                      <div class="ac-container"></div>
                    </td>
                    <td>
                      <input type="text" class="form-control ac-control" id="board_tesorero_last_name" name="board_tesorero_last_name" value="" ac-method="clients" ac-master-field="legal_tesoreroId" required title="Inserte el nombre del tesorero">
                      <div class="ac-container"></div>
                    </td>
                    <td>
                      <input type="text" class="form-control ac-ruc" id="board_tesorero_id" name="board_tesorero_id" value="" required title="Inserte el RUC del tesorero">
                    </td>
                    <td>Tesorero</td>
                  </tr>
                </tbody>
            ...
            <table class="table table-bordered table-hover table-striped">
              ...
              <tbody id="shareholder_container">
                  <tr>
                    ...
                    <td>
                      <select id="shareholder_client_people_action_typeId" name="shareholder_client_people_action_typeId" required title="Inserte el tipo de acción">
                        <option></option>
